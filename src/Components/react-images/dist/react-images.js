(function(global, factory) {
  ...
  ScrollLock =
    ScrollLock && ScrollLock.hasOwnProperty("default") ? ScrollLock["default"] : ScrollLock;
  ...
  function Container(_ref, _ref2) {
    ...
    return React__default.createElement(
      "div",
      _extends({ id: "lightboxBackdrop", className: noImportant.css(classes.container) }, props)
    );
  }
  ...
  var PaginatedThumbnails = (function(_Component) {
    ...
    function PaginatedThumbnails(props) {
      ...
      var _this = possibleConstructorReturn(
        this,
        (PaginatedThumbnails.__proto__ || Object.getPrototypeOf(PaginatedThumbnails)).call(
          this,
          props
        )
      );
  ...
  var PassContext = (function(_Component) {
    ...
    function PassContext() {
      ...
      return possibleConstructorReturn(
        this,
        (PassContext.__proto__ || Object.getPrototypeOf(PassContext)).apply(this, arguments)
      );
    }
          ...
          reactDom.render(
            React__default.createElement(
              ...
              React__default.createElement(
                "div",
                null,
                React__default.createElement("style", null, styles),
                React__default.createElement(
  ...
  var Lightbox = (function(_Component) {
    ...
    createClass(Lightbox, [
      ...
      },
      {
        key: "render",
        value: function render$$1() {
          return React__default.createElement(Portal, null, this.renderDialog());
        }
      }
    ]);
    return Lightbox;
