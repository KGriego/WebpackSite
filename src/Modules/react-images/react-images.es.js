...
// header
theme.header = { height: 40 };
theme.close = { fill: "white" };
...
// thumbnails
theme.thumbnail = { activeBorderColor: "white", size: 50, gutter: 2 };

// arrow
theme.arrow = { background: "none", fill: "white", height: 120 };
...
function deepMerge(target) {
  ...
  let extended = Object.assign({}, target);
...
let icons = { arrowLeft: arrowLeft, arrowRight: arrowRight, close: close };

let Icon = function Icon(_ref) {
  let fill = _ref.fill,
    type = _ref.type,
  ...
  return React.createElement(
    "span",
    _extends({ dangerouslySetInnerHTML: { __html: icon(fill) } }, props)
  );
};
...
function Arrow(_ref, _ref2) {
  ...
  let classes = StyleSheet$1.create(deepMerge(defaultStyles$1, theme$$1));
...
function Container(_ref, _ref2) {
  let theme$$1 = _ref2.theme;
  let props = objectWithoutProperties(_ref, []);

  let classes = StyleSheet$1.create(deepMerge(defaultStyles$2, theme$$1));

  return React.createElement(
    "div",
    _extends(
      { id: "lightboxBackdrop", className: css$1(classes.container) },
      props
    )
  );
}
...
function Footer(_ref, _ref2) {
  ...
  let classes = StyleSheet$1.create(deepMerge(defaultStyles$3, theme$$1));

  let imageCount = showCount
    ? React.createElement(
      "div",
...
function Header(_ref, _ref2) {
  let theme$$1 = _ref2.theme;
  let customControls = _ref.customControls,
  ...
  let classes = StyleSheet$1.create(deepMerge(defaultStyles$4, theme$$1));
...
function Thumbnail(_ref, _ref2) {
  ...
  let url = thumbnail ? thumbnail : src;
  let classes = StyleSheet$1.create(deepMerge(defaultStyles$5, theme$$1));
...
let classes = StyleSheet$1.create({
  paginatedThumbnails: {
...
let PaginatedThumbnails = (function (_Component) {
  ...
  function PaginatedThumbnails(props) {
    ...
    let _this = possibleConstructorReturn(
      this,
      (
        PaginatedThumbnails.__proto__ ||
        Object.getPrototypeOf(PaginatedThumbnails)
      ).call(this, props)
    );
  ...
  createClass(PaginatedThumbnails, [
    ...
    },
    {
      ...
      value: function clampFirst(value) {
        ...
        let totalCount = 2 * offset + 1; // show $offset extra thumbnails on each side
      ...
      value: function render$$1() {
        ...
        return React.createElement(
          ...
          thumbnails.map(function (img, idx) {
            return React.createElement(
              Thumbnail,
              _extends({ key: baseOffset + idx }, img, {
...
let PassContext = (function (_Component) {
  ...
  function PassContext() {
    ...
    return possibleConstructorReturn(
      this,
      (PassContext.__proto__ || Object.getPrototypeOf(PassContext)).apply(
        this,
        arguments
      )
    );
...
let Portal = (function (_Component) {
  ...
  function Portal() {
    ...
    let _this = possibleConstructorReturn(
      this,
      (Portal.__proto__ || Object.getPrototypeOf(Portal)).call(this)
    );
...
let Spinner = function Spinner(props) {
  let classes = StyleSheet$1.create(styles(props));
...
function normalizeSourceSet(data) {
  let sourceSet = data.srcSet || data.srcset;
...
let Lightbox = (function (_Component) {
  ...
  function Lightbox(props) {
    ...
    let _this = possibleConstructorReturn(
      this,
      (Lightbox.__proto__ || Object.getPrototypeOf(Lightbox)).call(this, props)
    );
  ...
  createClass(Lightbox, [
    ...
    },
    {
      ...
      value: function componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.preloadNextImage) {
          let currentIndex = this.props.currentImage;
          let nextIndex = nextProps.currentImage + 1;
          let prevIndex = nextProps.currentImage - 1;
          let preloadIndex = void 0;
    ...
    },
    {
      ...
      value: function preloadImageData(data, onload) {
        if (!data) return;
        let img = new Image();
        let sourceSet = normalizeSourceSet(data);
    ...
    },
    {
      ...
      value: function renderImages() {
        ...
        let sourceSet = normalizeSourceSet(image);
        let sizes = sourceSet ? "100vw" : null;

        let thumbnailsSize = showThumbnails ? this.theme.thumbnail.size : 0;
        let heightOffset =
